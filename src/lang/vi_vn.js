export default {
  ...
  edit: {
    ...
    localStorageExceededTip:
      'Dung lượng sơ đồ tư duy bạn tạo đã vượt quá giới hạn lưu trữ tối đa của trình duyệt. Vui lòng xuất ngay lập tức, nếu không dữ liệu có thể bị mất.',
  ...
  attachment: {
    ...
    tip: 'Phiên bản hiện tại chưa hỗ trợ chức năng đính kèm'
  },
  annotation: {
    mark: 'Đánh dấu',
  ...
  ai: {
    ...
    connectFailedTitle: 'Kết nối dịch vụ AI thất bại',
    connectFailedTip: 'Không thể kết nối tới dịch vụ AI cục bộ. Vui lòng kiểm tra:',
    connectFailedCheckTip1:
      '1. Dịch vụ AI cục bộ đã được khởi động hay chưa.',
    connectFailedCheckTip2:
      '2. Cổng cấu hình có khớp với dịch vụ cục bộ hay không.',
    connectFailedCheckTip3:
      '3. Nếu dịch vụ đang chạy, hãy thử khởi động lại rồi kiểm tra lại.',
    ...
    mindMappingClientConfiguration: 'Cấu hình dịch vụ AI cục bộ:',
    port: 'Cổng',
    cancel: 'Hủy',
    confirm: 'Xác nhận',
    close: 'Đóng',
