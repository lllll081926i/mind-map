export default {
  ...
  edit: {
    ...
    localStorageExceededTip:
      'The mind map you created has exceeded the maximum browser storage limit. Please export it immediately, otherwise the data may be lost.',
  ...
  attachment: {
    ...
    tip: 'Attachments are not supported in the current version'
  },
  annotation: {
    mark: 'Mark',
    show: 'Show mark',
  ...
  ai: {
    ...
    connectFailedTitle: 'AI service connection failed',
    connectFailedTip: 'Unable to reach the local AI service. Please check:',
    connectFailedCheckTip1:
      '1. Whether the local AI service has been started.',
    connectFailedCheckTip2:
      '2. Whether the configured port matches the local service.',
    connectFailedCheckTip3:
      '3. If the service is already running, try restarting it and test again.',
    connectFailedCheckTip4:
      'After completing the above steps, you can click:',
    ...
    mindMappingClientConfiguration: 'Local AI service configuration:',
    port: 'Port',
    cancel: 'Cancel',
    confirm: 'Confirm',
    close: 'Close',
