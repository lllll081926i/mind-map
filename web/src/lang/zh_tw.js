export default {
  ...
  edit: {
    ...
    localStorageExceededTip:
      '你創建的思維導圖體積已經超過瀏覽器允許存儲的上限，請立即導出，否則數據將丟失！',
    withBg: '帶背景'
  },
  mouseAction: {
  ...
  ai: {
    chatTitle: 'AI對話',
    clearRecords: '清空記錄',
    connectFailedTitle: 'AI 服務連接失敗',
    connectFailedTip: '未連接到本地 AI 服務，請檢查：',
    connectFailedCheckTip1: '1.是否已經在本地啟動 AI 服務。',
    connectFailedCheckTip2: '2.連接埠設定是否與本地服務一致。',
    connectFailedCheckTip3: '3.如已啟動服務，可嘗試重新啟動後再次檢測。',
    ...
    mindMappingClientConfiguration: '本地 AI 服務配置：',
    port: '端口',
    cancel: '取消',
    confirm: '確認',
    close: '關閉',
