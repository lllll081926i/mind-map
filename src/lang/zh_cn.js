export default {
  ...
  setting: {
    ...
    updateAvailableMessage: '发现新版本 v{version}，是否立即下载并安装？',
    updateInstallNow: '立即安装',
    updateLater: '稍后处理',
    updateFoundWithoutUrl: '发现新版本 v{version}',
    updateAlreadyLatest: '当前已是最新版本 v{version}',
    updateReleasePageOnly: '当前无法自动安装更新，是否打开发布页面手动检查？',
    openReleasePage: '打开发布页',
    updateSourceNotConfigured:
      '当前未配置更新源，请在构建环境中设置发布页或更新清单地址。',
    ...
    updateInstallCompleted: '新版本 v{version} 已安装完成，是否立即重启应用？',
    updateRestartTitle: '重启应用',
    updateRestartNow: '立即重启',
    updateRestartLater: '稍后重启',
    updateWindowsInstalling: '安装程序已启动，应用可能会自动关闭并进入更新。',
  ...
  ai: {
    chatTitle: 'AI对话',
    clearRecords: '清空记录',
    connectFailedTitle: 'AI 服务连接失败',
    connectFailedTip: '未连接到本地 AI 服务，请检查：',
    connectFailedCheckTip1: '1.是否已经在本地启动 AI 服务。',
    connectFailedCheckTip2: '2.端口配置是否与本地服务一致。',
    connectFailedCheckTip3: '3.如已启动服务，可尝试重启后再次检测。',
    ...
    providerConfiguration: 'AI Provider 配置：',
    provider: 'Provider',
    providerVolcanoArk: '火山方舟',
    providerOpenAI: 'OpenAI',
    providerDeepSeek: 'DeepSeek',
    providerSiliconFlow: 'SiliconFlow',
    providerCustomOpenAI: '自定义 OpenAI 兼容接口',
    baseUrl: 'Base URL',
    apiPath: '接口路径',
    modelName: '模型 ID',
    VolcanoArkLargeModelConfiguration: 'AI Provider 配置：',
    configTip:
      '当前已改为 Provider 驱动配置，现阶段支持 OpenAI Compatible 协议服务，火山方舟只是内置 Provider 之一。',
    course: '教程',
    inferenceAccessPoint: '推理接入点',
    mindMappingClientConfiguration: '本地 AI 服务配置：',
    port: '端口',
    cancel: '取消',
    confirm: '确认',
    close: '关闭',
    configSaveSuccessTip: '配置保存成功',
    providerValidateTip: '请选择 Provider',
    baseUrlValidateTip: '请输入 Base URL',
